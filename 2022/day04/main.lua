...
local function isOverlap(pair)
    local firstContainsSecond = pair.first.lower <= pair.second.lower
        and pair.first.upper >= pair.second.upper
    local secondContainFirst = pair.first.lower >= pair.second.lower
        and pair.first.upper <= pair.second.upper
...
local function isOverlapSecond(pair)
    local firstOverlap = pair.first.upper >= pair.second.lower
        and pair.first.lower <= pair.second.upper
    local secondOverlap = pair.second.upper <= pair.first.lower
        and pair.second.upper >= pair.first.lower
